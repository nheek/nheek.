      ...
      {!isOpen ? (
        ...
        >
          ...
          <div className="relative mx-auto w-32 h-24">
            <div className="absolute inset-0 bg-gradient-to-br from-orange-300 via-yellow-200 to-orange-300 rounded-full transform rotate-45 shadow-2xl border-2 border-orange-400">
              <div className="absolute inset-4 bg-gradient-to-br from-orange-200 to-yellow-100 rounded-full" />
            </div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-1 bg-orange-900/20 transform rotate-45" />
          </div>
          <p className="text-center text-sm text-gray-400 mt-4 group-hover:text-white transition">
            click to open 🥠
          </p>
        </button>
      ) : (
        <div className="bg-gradient-to-br from-yellow-50 to-orange-50 p-6 rounded-lg border-2 border-orange-300 shadow-xl">
