...
export default function Custom404() {
    return (
        <main className={"flex flex-col items-center justify-center bg-[#1C2951] min-h-screen h-full text-white"}>
            ...
            <Link
                href="/">
                <button className="text-3xl mt-4 px-4 py-2 border-2 border-solid border-gray-200 text-center leading-[normal] rounded-3xl hover:bg-gray-200 hover:text-blue-950 duration-500">Home</button>
            </Link>
        </main>
    );
}