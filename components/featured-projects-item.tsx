...
export default function FeaturedProjectsItem({ isFullStack = false, category = "websites" }) {
  ...
  const projects = {
    websites: [
      ...
      { name: 'shareme', desc: 'no-login todo list web app', bug: true, link: 'https://shareme.nheek.com/', image: '/featured-projects/shareme.png', mobileImage: '/featured-projects/mobile/m-shareme.png', techstack: ['PHP', 'JavaScript', 'jQuery', 'MySQL', 'TailwindCSS'], onGithub: "https://github.com/nheek/shareme" },
