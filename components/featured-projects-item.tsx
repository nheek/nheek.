...
export default function FeaturedProjectsItem({ isFullStack = false, category = "websites" }) {
  ...
  const projects_no = {
    websites: [
      ...
      { name: 'spring', new: true, status: "under vedlikehold", desc: 'jobbportalplattform', link: 'https://spring.nheek.com/', image: '/featured-projects/spring.png', techstack: ['Angular', 'TypeScript', 'Spring Boot', 'Maven', 'PostgreSQL', 'TailwindCSS'], deployedWith: ["docker", "github actions"] },
