...
export default function FeaturedProjectsItem({ isFullStack = false, category = "websites" }) {
  ...
  const projects = {
    websites: [
      ...
      { name: 'spring', new: true, status: "under construction", desc: 'job portal platform', link: 'https://spring.nheek.com/', image: '/featured-projects/spring.png', techstack: ['Angular', 'TypeScript', 'Spring Boot', 'Maven', 'PostgreSQL', 'TailwindCSS'], deployedWith: ["docker", "github actions"] },
      ...
      { name: 'confy', desc: 'anonymous confession site', link: 'https://confy.nheek.com/', image: '/featured-projects/confy.png', techstack: ['RemixJS', 'ReactJS', 'NodeJS', 'TypeScript', 'MySQL', 'TailwindCSS'], deployedWith: ["docker", "github actions"] },
      ...
      { name: 'free', new: true, desc: 'anonymous freedom wall', link: 'https://free.nheek.com/', image: '/featured-projects/free.png',  mobileImage: '/featured-projects/mobile/m-free.png', techstack: ['NextJS', 'ReactJS', 'NodeJS', 'TypeScript', 'MySQL', 'TailwindCSS'], deployedWith: ["docker", "github actions"] },
    ],
    desktopApps: [
    ...
    contributions: [
      ...
      { name: 'kvarteret', new: true, status: 'under construction', desc: 'student culture center', link: 'https://kvarteret.no/', image: '/featured-projects/contributions/kvarteret.png', mobileImage: '/featured-projects/mobile/contributions/m-kvarteret.png', techstack: ['AstroJS', 'ReactJS', 'GraphQL', 'Directus', 'CSS'] },
    ],
    static: [
      ...
      { name: 'truhvel', new: true, desc: 'underwater exploration landing page', link: 'https://truhvel.nheek.com/', image: '/featured-projects/static/truhvel.png', techstack: ['VueJS', 'ViteJS', 'TypeScript', 'CSS'], deployedWith: ["docker", "github actions"] },
    ],
    template: [
  ...
  const projects_no = {
    websites: [
      ...
      { name: 'spring', new: true, status: "under arbeid", desc: 'jobbportalplattform', link: 'https://spring.nheek.com/', image: '/featured-projects/spring.png', techstack: ['Angular', 'TypeScript', 'Spring Boot', 'Maven', 'PostgreSQL', 'TailwindCSS'], deployedWith: ["docker", "github actions"] },
      ...
      { name: 'free', new: true, desc: 'anonymt freedom wall', link: 'https://free.nheek.com/', image: '/featured-projects/free.png',  mobileImage: '/featured-projects/mobile/m-free.png', techstack: ['NextJS', 'ReactJS', 'NodeJS', 'TypeScript', 'MySQL', 'TailwindCSS'], deployedWith: ["docker", "github actions"] },
    ],
    desktopApps: [
    ...
    contributions: [
      ...
      { name: 'kvarteret', new: true, status: 'under arbeid', desc: 'studentkulturhuset', link: 'https://kvarteret.no/', image: '/featured-projects/contributions/kvarteret.png', mobileImage: '/featured-projects/mobile/contributions/m-kvarteret.png', techstack: ['AstroJS', 'ReactJS', 'GraphQL', 'Directus', 'CSS'] },
    ],
    static: [
      ...
      { name: 'truhvel', new: true, desc: 'landingsside for undervannsutforskning', link: 'https://truhvel.nheek.com/', image: '/featured-projects/static/truhvel.png', techstack: ['VueJS', 'ViteJS', 'TypeScript', 'CSS'] },
    ],
    template: [
  ...
  const projects_fullstack = {
    ...
    static: [
      ...
      { name: 'truhvel', new: true, desc: 'underwater exploration landing page', link: 'https://truhvel.nheek.com/', image: '/featured-projects/static/truhvel.png', techstack: ['VueJS', 'ViteJS', 'TypeScript', 'CSS'] },
