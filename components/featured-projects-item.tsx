...
export default function FeaturedProjectsItem({ isFullStack = false, category = "websites" }) {
  ...
  const projects = {
    ...
    contributions: [
      ...
      { name: 'homing', status: 'under construction', desc: 'social media messaging web app', link: 'https://homing.lukasry.no/', image: '/featured-projects/contributions/homing.png', techstack: ['PHP', 'JavaScript', 'MySQL', 'JQuery', 'CSS'], collaborators: [{name: "Lukas Rysjedal", link: "https://github.com/LukasRysjedal"}] },
    ],
    static: [
