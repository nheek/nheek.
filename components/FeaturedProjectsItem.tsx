...
export default function FeaturedProjectsItem({
  ...
  const projects = {
    ...
    contributions: [
      ...
      { name: 'boskonf', dateAdded: '02.08.2024', status: 'under construction', desc: 'bergen open source conference', link: 'https://boskonf.no/', image: '/featured-projects/contributions/boskonf.png', mobileImage: '/featured-projects/mobile/contributions/m-boskonf.png', techstack: ['NextJS', 'ReactJS', 'TypeScript', 'CSS'], onGithub: "https://github.com/fribyte-code/boskonf.no" },
  ...
  const projects_no = {
    ...
    contributions: [
      ...
      { name: 'boskonf', dateAdded: '02.08.2024', status: 'under arbeid', desc: 'bergen open source konferanse', link: 'https://boskonf.no/', image: '/featured-projects/contributions/boskonf.png', mobileImage: '/featured-projects/mobile/contributions/m-boskonf.png', techstack: ['NextJS', 'ReactJS', 'TypeScript', 'CSS'], onGithub: "https://github.com/fribyte-code/boskonf.no" },
