...
interface FeaturedMusicClientProps {
  featuredAlbums: Album[];
  regularAlbums: Album[];
}

export default function FeaturedMusicClient({
  featuredAlbums,
  regularAlbums,
}: FeaturedMusicClientProps) {
  return (
    <div className="w-[85%] mx-auto mt-6 mb-20">
      <Link href="/music">
        <h2 className="text-2xl md:text-[3rem] xl:text-[4rem] text-center mt-40 mb-8 hover:text-purple-400 transition-colors cursor-pointer">
          featured music
        </h2>
      </Link>
